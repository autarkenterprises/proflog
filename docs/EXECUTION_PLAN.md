...
| [ADR-0036](adr/ADR-0036-speculative-relational-arithmetic-and-tabling.md) | proposed | `adr-0036-spec-relational-arithmetic-tabling` | speculative faster-minikanren arithmetic translation and core.logic tabling reassessment | ADR-0029, ADR-0017, ADR-0035 | translated `numbers.scm` tests, upstream `test-numbers.scm` cases, opt-in bit-list `step-fuelo`, and tabling probes for ADR-0035 list-kernel rows | merge only if correctness and performance evidence justify replacing or extending existing production fuel/tabling behavior |
| [ADR-0037](adr/ADR-0037-core-logic-minikanren-enhancements.md) | proposed | `adr-0037-core-logic-minikanren-enhancements` | project-local core.logic miniKanren feature and performance enhancements | ADR-0032, ADR-0036 | miniKanren implementation survey, core.logic TODO/performance audit, constraint feature tests, fuel replacement probes, and Proflog integration audit | decide whether to carry a project-local enhanced core.logic overlay before replacing finite-domain fuel arithmetic or Proflog-specific type/membership checks |
...
proposed ADR-0036.
Core.logic miniKanren enhancement work has graduated into proposed ADR-0037.
