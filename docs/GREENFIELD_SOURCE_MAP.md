...
| `proflog.combinatory-logic` | ADR-46 SKI combinatory-logic demonstration. | Defines SKI reduction and bounded evaluation as frontend Proflog clauses. Host helpers construct terms only; they do not reduce SKI expressions. |
