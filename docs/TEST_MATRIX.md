...
| Proof profiles and deduction modulo | language-level profile metadata, profile dispatch, kernel-interleaved theory conversion, and unified Q3 predecessor-equality proof markers | Robinson Q as ordinary assumptions and as `:robinson-q` conversion/Q3 profile | common theorem timing comparison, source audit against host preprocessing and old Q3 closers, and proof evidence distinguishing assumptions from interleaved Q conversion and Q3 predecessor equality | yes when production query dispatch changes |
