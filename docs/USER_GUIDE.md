...
`mult/3` tables or miniature certificate predicates. Reflected user clauses are
part of the self-referenced system; external clauses are ordinary Proflog code
