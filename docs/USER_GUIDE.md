...
| Willard SJAS MVP | Generated by `proflog.willard-sjas/system` | `proflog.kernel.willard-sjas-profile` | Finite SJAS-lang substrate with generated axiom codes, Group-3, and reflected clause boundary. |
...
The Willard SJAS MVP is built with `proflog.willard-sjas/system-source` or the
...
| Willard SJAS MVP | [willard-sjas.md](../worked-examples/willard-sjas.md) | Generated SJAS basis, reflected/external clause boundary, formula classes, certificate predicates. |
...
| `proflog.kernel.willard-sjas-profile` | profile | MVP Willard SJAS profile wrapper around generated relation predicates. |
...
| `proflog.willard-sjas` | public examples/profile data | MVP Willard SJAS language, builder, classifiers, generated predicates, and query helper. |
