...
| [ADR-0036](ADR-0036-speculative-relational-arithmetic-and-tabling.md) | proposed | `adr-0036-spec-relational-arithmetic-tabling` | speculative faster-minikanren arithmetic translation and core.logic tabling reassessment | pending |
| [ADR-0037](ADR-0037-core-logic-minikanren-enhancements.md) | proposed | `adr-0037-core-logic-minikanren-enhancements` | project-local core.logic miniKanren feature and performance enhancements | pending |
