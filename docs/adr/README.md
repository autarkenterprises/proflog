...
| [ADR-0016](ADR-0016-fair-agenda-and-micro-fuel.md) | accepted | `adr-0016-fair-scheduling` | fair agenda scheduling and refined micro-step fuel | pending |
| [ADR-0017](ADR-0017-relational-tabling-and-canonical-state.md) | accepted | `adr-0017-relational-tabling` | separate relational tabling and canonical proof-state reuse | pending |
