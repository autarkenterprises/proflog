...
| [ADR-0019](ADR-0019-closed-term-gamma-instantiation.md) | proposed | `adr-0019-closed-term-gamma-instantiation` | generic bounded closed-term generation for Fitting gamma instantiation | pending |
