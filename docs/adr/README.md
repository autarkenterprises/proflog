...
| [ADR-0022](ADR-0022-pelletier-problems.md) | proposed | `adr-0022-pelletier-problems` | replicate the upstream alphaleanTAP Pelletier problem benchmark suite in greenfield | pending |
