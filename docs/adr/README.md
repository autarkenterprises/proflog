...
| [ADR-0041](ADR-0041-relational-constructor-recursive-profile.md) | proposed | `adr-0041-relational-constructor-recursive-profile` | promote constructor-recursive descent into a relationally pure dispatched kernel profile | pending |
