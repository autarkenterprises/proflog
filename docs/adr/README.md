...
| [ADR-0042](ADR-0042-equality-fragment-status-consistency.md) | proposed | `adr-0042-equality-fragment-status-consistency` | assess and correct equality-fragment `:inconsistent` status behavior for universal finite-domain formulas | pending |
