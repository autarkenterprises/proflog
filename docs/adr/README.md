...
| [ADR-0030](ADR-0030-relational-constructor-search.md) | accepted | `adr-0030-relational-constructor-search` | generic relational constructor search control for raw list-family proof closure | pending |
