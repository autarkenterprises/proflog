...
| [ADR-0035](ADR-0035-relational-residual-continuation.md) | accepted | `adr-0035-relational-residual-continuation` | relational answer-overlay replacement for constructor-recursive residual settlement | pending |
