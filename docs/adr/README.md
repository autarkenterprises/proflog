...
| [ADR-0018](ADR-0018-existential-disequality-witnesses.md) | accepted | `adr-0018-existential-disequality-witnesses` | accurate object-language witnesses for existential disequality programs | pending |
