...
| [ADR-0031](ADR-0031-list-family-kernel-generalization.md) | accepted | `adr-0031-list-family-kernel-generalization` | revisit ADR-0030 against family-level append/reverse kernel generalization | pending |
